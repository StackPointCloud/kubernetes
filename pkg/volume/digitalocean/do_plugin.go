...
func ProbeVolumePlugins() []volume.VolumePlugin {
	return []volume.VolumePlugin{&doVolumePlugin{nil}}
}
...
func (plugin *doVolumePlugin) newProvisionerInternal(options volume.VolumeOptions, manager *doManager) volume.Provisioner {
